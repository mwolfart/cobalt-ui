...
function lr() {
  if (Oe)
    return A;
  Oe = 1;
  var P = we, h = Symbol.for("react.element"), j = Symbol.for("react.fragment"), T = Object.prototype.hasOwnProperty, $ = P.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, W = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(E, c, O) {
    var p, b = {}, R = null, Y = null;
    O !== void 0 && (R = "" + O), c.key !== void 0 && (R = "" + c.key), c.ref !== void 0 && (Y = c.ref);
    for (p in c)
      T.call(c, p) && !W.hasOwnProperty(p) && (b[p] = c[p]);
    if (E && E.defaultProps)
      for (p in c = E.defaultProps, c)
        b[p] === void 0 && (b[p] = c[p]);
    return { $$typeof: h, type: E, key: R, ref: Y, props: b, _owner: $.current };
  }
...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === T || e === W || Ae || e === $ || e === O || e === p || Fe || e === Y || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === b || e.$$typeof === x || e.$$typeof === E || e.$$typeof === c || // This needs to include all possible module reference object
...
var vr = Z.exports;
const pr = ({ variant: P, onClick: h, children: j }) => /* @__PURE__ */ vr.jsx("button", { className: `button-${P}`, onClick: h, children: j });
export {
  pr as Button
};
